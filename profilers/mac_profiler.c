...
//
// Modified by James Connolly <james@silogy.io> on 2024, to allow for simple
// profling of processes
...
// NOTE: string is heap allocated -- process ends right after this so i dont
// care tbh
